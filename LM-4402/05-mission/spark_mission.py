...
ACCESS_TOKEN 	= "MWU1ZDE4YzItMjllMi00YjdiLWExYzktZDNkODFlZDk4N2FjOTJmNjI4MTQtZWZl"
ROOM_NAME	= "sparkroomv1"
YOUR_MESSAGE 	= "Hello room! My script verified that I can post messages to Spark using REST API calls"
